  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      i.addEventListener("drop", function (e) {
        ...
        if (this != dragged) {
          var all = document.querySelectorAll("#sortlist li"),
              draggedpos = 0,
              droppedpos = 0;
          ...
          var draggedID = dragged.attributes.id.value;
          var droppedID = this.attributes.id.value;
          (0, _week.updateWeek)(draggedID, droppedID);
        }
