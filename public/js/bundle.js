...
exports.updatePassword = exports.updateMe = exports.signup = exports.logout = exports.login = void 0;
...
exports.removeFromWeek = exports.addToWeek = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Error adding plate to week.');
...
var updatePlateForm = document.querySelector('.form__createPlate-updatePlate'); // const IDinput = document.getElementById('plateID');
...
var selectRow = document.querySelectorAll('.row__btn').forEach(function (item) {
  item.addEventListener('click', function (e) {
    ...
    var removePlate = document.getElementById(item.firstElementChild.id);
    console.log(removePlate.value);
    (0, _week.removeFromWeek)(removePlate.value);
  });
});
