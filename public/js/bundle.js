...
exports.deleteMe = exports.updatePassword = exports.updateMe = exports.signup = exports.logout = exports.login = void 0;
...
var signup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(name, username, email, password, passwordConfirm) {
    var res, error;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status == 'success') {
              (0, _alert.showAlert)('success', 'Created account successfully!'); // console.log(res.data)
...
var updateMe = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status == 'success') {
              (0, _alert.showAlert)('success', 'Updated user successfully!');
  ...
  return function updateMe(_x8, _x9) {
...
var updatePassword = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(currentPassword, newPassword, passwordConfirm) {
    var res;
...
var deleteMe = /*#__PURE__*/function () {
  ...
  return function deleteMe(_x13) {
    return _ref6.apply(this, arguments);
  };
}();

exports.deleteMe = deleteMe;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"plate.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updatePlate = exports.deletePlate = exports.createPlate = void 0;
...
var createPlate = /*#__PURE__*/function () {
...
var deletePlate = /*#__PURE__*/function () {
...
var updatePlate = /*#__PURE__*/function () {
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"week.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.emailWeek = exports.updateWeek = exports.removeFromWeek = exports.addToWeek = void 0;
...
var addToWeek = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(plateID) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/v1/plates/".concat(plateID),
              data: {
                id: plateID
              }
            });
          ...
          case 3:
            ...
            if (res.data.status == 'success') {
              (0, _alert.showAlert)('success', 'Added plate to week!'); // console.log(res.data);
            }
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alert.showAlert)('error', 'Error adding plate to week. Check that you have less than 7 plates per week!');
  ...
  return function addToWeek(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.addToWeek = addToWeek;

var removeFromWeek = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(plateID) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'delete',
              url: "/api/v1/plates/remove/".concat(plateID),
              data: {
                id: plateID
              }
            });
          ...
          case 7:
            _context2.prev = 7;
            _context2.t0 = _context2["catch"](0);
            (0, _alert.showAlert)('error', 'Error removing plate from week.');
  ...
  return function removeFromWeek(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.removeFromWeek = removeFromWeek;

var updateWeek = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(draggedID, droppedID) {
    var res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            _context3.prev = 7;
            _context3.t0 = _context3["catch"](0);
            (0, _alert.showAlert)('error', 'Error updating week.');
  ...
  return function updateWeek(_x3, _x4) {
    return _ref3.apply(this, arguments);
  };
}();
...
var emailWeek = /*#__PURE__*/function () {
...
exports.emailWeek = emailWeek;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"../../node_modules/sortablejs/modular/sortable.esm.js":[function(require,module,exports) {
"use strict";
...
//allow newer javascript features to work in older browsers
...
var updatePasswordForm = document.querySelector('.form__login-password');
var createPlateForm = document.querySelector('.form__createPlate-addPlate');
var logOutBtn = document.querySelector('.navbar__link-logout');
...
if (updateMeForm) {
  updateMeForm.addEventListener('submit', function (e) {
    ...
    formData.append('photo', document.getElementById('photo').files[0]); // for (var p of formData) {
    //     console.log(p);
    // }

    (0, _login.updateMe)(formData, id);
  });
}
...
var myList = document.getElementById("sortlist");
var sortable = new _sortablejs.default(myList, {
  // handle:'.handle',
  animation: 200,
  onChoose: function onChoose(e) {
    console.log("element ".concat(e.oldIndex, " chosen"));
  },
  ...
  onEnd: function onEnd(e) {
    ...
    console.log("oldIndex:  ".concat(e.oldIndex));
    console.log("newIndex:  ".concat(e.newIndex));
    (0, _week.updateWeek)(e.oldIndex, e.newIndex);
  }
